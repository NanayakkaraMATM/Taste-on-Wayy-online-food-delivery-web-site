...
<ul id = "myDIV" class="sign" style ="margin-left:10px">
	...
	<li class="sign"><a href="login page.php">Login</a></li>
		...
		<a href = "#">
		<img src = "../images/shopping cart.png" style="float:right; margin-right: 195px; margin-top:-115px" width = "40px" height = "29px">
		</a>
	
<br><br><br>

<img src="../images/profile1.png" alt="Logo" style="float:left; margin-left:10px; margin-top:-135px" width = "210px" height = "170px">
	...
	<h1 class = "topic" > Taste On Wayy</h1><br><br>

	<form class="searchbar1" action="#">
	<input type="text" placeholder="Search by Location (eg:-Malabe)" name="search">
	<br><br>
	<button type="submit"><a href = "MenuPage.php" style="font-size:16px; color : white; font-weight:bold; "><i class="fa fa-search" style = "margin-right:8px"></i>Search</a></button> </form>
	<br><br><br>
	
	<form class="searchbar2" action="#">
	<input type="text" placeholder="Search by Restaurant (eg:-Pizza ZaZa)" name="search2">
	<br><br>
	<button type="submit1"><a href = "MenuPage.php" style="font-size:16px; color : white; font-weight:bold; "><i class="fa fa-search" style = "margin-right:8px"></i>Search</a></button>
	</form>
	</center>
