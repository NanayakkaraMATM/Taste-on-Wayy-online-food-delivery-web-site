...
<link rel="stylesheet" href="../styles/styleThank.css">
...
<center>
<img src="../images/profile1.png" alt="Logo" width = "250px" height = "200px">
<br><br><br><br><br><br><br><br>
    ...
    <h2> You have successfully <br>registered as a <br>Driver </h2>
	
	<div class="dropdown" style = "margin-top: -1px; float:right; margin-right: -2px">
	
    <button class="dropbtn" style = "width:166px">Logout<i class="arrow down"></i>
...
<br><br><br>
		...
		<div id="innerFooter">
			...
			<div id="Child1">
				...
				<li><a href="Terms and Conditions.html">TERMS & CONNDITIONS</a></li><br>
				<li><a href="Privacy Policy.html">PRIVACY POLICY</a></li><br>
				<li><a href="promotion page.html">PROMOTIONS</a></li>
			</div>
			<div id="Child2">
